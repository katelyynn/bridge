...
execute if score map internal matches 1 run setblock -16 93 0 structure_block{mirror:"NONE",seed:0L,posX:-33,posY:-6,posZ:-14,sizeX:34,sizeY:37,sizeZ:29,name:"bridge:maps/urban_blue",rotation:"NONE",mode:"LOAD"}
