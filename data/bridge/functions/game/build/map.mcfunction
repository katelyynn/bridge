...
# Twilight
execute if score map internal matches 2 run setblock 16 93 0 structure_block{mirror:"NONE",seed:0L,posX:0,posY:-12,posZ:-13,sizeX:25,sizeY:34,sizeZ:41,name:"bridge:maps/twilight_red",rotation:"NONE",mode:"LOAD"}
execute if score map internal matches 2 run setblock -16 93 0 structure_block{mirror:"NONE",seed:0L,posX:-25,posY:-12,posZ:-13,sizeX:34,sizeY:37,sizeZ:29,name:"bridge:maps/twilight_blue",rotation:"NONE",mode:"LOAD"}
