...
execute if score map internal matches 1 run setblock -16 93 0 structure_block{mirror:"NONE",seed:0L,posX:-33,posY:-6,posZ:-10,sizeX:32,sizeY:34,sizeZ:24,name:"bridge:maps/treehouse_blue",rotation:"NONE",mode:"LOAD"}
